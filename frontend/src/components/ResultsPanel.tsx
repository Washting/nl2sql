        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="h-8 px-3 text-muted-foreground hover:text-cyan-400"
            >
      ...
      <div className="flex-1 overflow-auto min-h-0 px-4 py-4">
        {!queryResult || !queryResult.data || queryResult.data.length === 0 ? (
          ...
          <div className="space-y-4">
            {/* Data Table */}
            <div className="bg-card/50 rounded-lg border border-border/40 overflow-hidden">
                ...
                <Table>
                  ...
                  <TableBody>
                    {queryResult.data.map((row: any, rowIdx: number) => (
                      <TableRow key={rowIdx} className="border-border/40 hover:bg-white/5">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      {queryResult.data.length > 20 && (
                        <span className="text-xs text-muted-foreground">（显示前20条）</span>
                      )}
                    </div>
                    <div className="flex gap-2">
                      <Button
                        ...
                        className={`text-xs h-7 ${chartType === 'bar'
                      ...
                      <Button
                        ...
                        className={`text-xs h-7 ${chartType === 'line'
            ...
            {queryResult.answer && queryResult.answer.trim() && (
              <div className="bg-card/50 rounded-lg border border-border/40 p-5">
                ...
                <div className="prose prose-sm prose-invert max-w-none">
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      p: ({ node, ...props }) => <p className="text-foreground/80 text-xs leading-relaxed mb-2" {...props} />,
